...
// This was Atlas Rail's home page ("/") before Agent Mandates became the front door. It moved here
// unchanged (import paths aside) so every existing treasury workflow keeps working exactly as before.
